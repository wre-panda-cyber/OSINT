...
TOOLS = [
    ...
    # Entreprise / Dirigeant (France)
    {"id": "pappers", "name": "Pappers", "category": "Entreprise / Dirigeant",
     "url": "https://www.pappers.fr/",
     "desc": "Données légales, juridiques et financières gratuites sur les entreprises françaises (dirigeants, bénéficiaires, BODACC)."},
    {"id": "recherche-entreprises-api", "name": "API recherche-entreprises (gouv.fr)", "category": "Entreprise / Dirigeant",
     "url": "https://recherche-entreprises.api.gouv.fr/",
     "desc": "API officielle gratuite (sans clé) fusions SIRENE/INSEE/INPI/BODACC. Intégrée à la recherche par nom de ce hub."},
    {"id": "infogreffe", "name": "Infogreffe", "category": "Entreprise / Dirigeant",
     "url": "https://www.infogreffe.fr/",
     "desc": "Registre officiel des tribunaux de commerce : Kbis, statuts, actes, dirigeants."},
    {"id": "societe-ninja", "name": "Societe.ninja", "category": "Entreprise / Dirigeant",
     "url": "https://societe.ninja/",
     "desc": "Informations légales et financières sur les entreprises, complémentaire de Pappers."},
    {"id": "data-inpi", "name": "Data INPI", "category": "Entreprise / Dirigeant",
     "url": "https://data.inpi.fr/",
     "desc": "Plateforme publique : marques, brevets, modèles, dessins, auto-entrepreneurs."},
    {"id": "rna", "name": "Registre national des associations (RNA)", "category": "Entreprise / Dirigeant",
     "url": "https://journal-officiel.gouv.fr/pages/associations-recherche/",
     "desc": "Informations légales sur les associations françaises (statut, dirigeants, historique)."},
    {"id": "sirene-fr", "name": "Base SIRENE (INSEE)", "category": "Entreprise / Dirigeant",
     "url": "https://www.insee.fr/fr/information/2008250",
     "desc": "Données officielles d'identification des entreprises et établissements (INSEE)."},
    # Phone
    ...
    {"id": "dnschecker", "name": "DNSChecker (web)", "category": "Site web / Domaine",
     "url": "https://dnschecker.org/",
     "desc": "Vérification de propagation DNS mondiale (100+ serveurs DNS) avec carte. Utile pour confirmer qu'un domaine est résolu partout."},
